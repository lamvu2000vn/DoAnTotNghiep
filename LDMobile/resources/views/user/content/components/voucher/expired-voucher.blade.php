    ...
    <div class='dis-voucher-right w-80'>
        <div class="voucher-right-content">
            ...
            <div class="d-flex justify-content-end">
                <div data-id="{{$voucher->id}}" class="relative dis-promotion-info-icon">
            ...
            <div class="d-flex justify-content-between">
                ...
                <div class="d-flex">
                    <div class="dis-condition-tag mr-10">Hết hạn</div>
                    {{-- nút xóa voucher --}}
                    <div data-id="{{$id}}" class="delete-voucher-btn"><i class="fas fa-trash"></i></div>
                </div>
            </div>
        </div>
    </div>
